...
class Print {
 public:
  ...
  // Mock implementation of write that does nothing
  virtual size_t write(uint8_t) { return 1; }

  size_t print(const char* str) { return str ? str_len(str) : 0; }
  ...
  size_t println(const char* str) { return str ? str_len(str) + 1 : 1; }
